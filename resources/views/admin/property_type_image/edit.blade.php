...
<style>
    ...
    /* Grid Gambar (Desktop 2 Kolom, Serupa dengan Detail) */
    .images-manage-grid {
        display: grid;
    ...
    /* Ukuran disamakan dengan Halaman Detail (16:9) */
    .preview-box {
        width: 100%;
        aspect-ratio: 16 / 9;
        height: auto;
    ...
    .block-info {
        ...
        align-items: center;
        width: 100%;
        gap: 10px; /* Jarak aman antara tombol dan teks */
    }
    ...
    /* Teks Caption Gambar (Diberi margin atas agar tidak nabrak) */
    .img-caption-edit {
        font-size: 14px;
        font-weight: 800;
        color: #555;
