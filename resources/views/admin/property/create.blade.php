...
<div class="page-container">
    ...
    <div class="form-card">
        <form action="{{ route('property.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Gambar Property <span style="font-weight: 400; text-transform: none; color: #888;">(Opsional)</span></label>
                ...
                <p style="font-size: 11px; color: #777; margin-top: 5px;">*Format: JPG, PNG, JPEG (Max 2MB). Boleh dikosongkan.</p>
            </div>

            <button type="submit" class="btn-submit">
                <i class="fa-solid fa-save" style="margin-right: 5px;"></i> Simpan Data Property
            </button>
        </form>
    </div>
</div>
