...
<style>
    ...
    /* Area Foto Profil - Preview disamakan dengan Index Testimoni */
...
<div class="page-container">
    <div class="header-flex">
        <h1 class="page-title">Tambah Testimoni</h1>
    ...
    <div class="form-card">
        <form action="{{ route('testimonial.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-full">
                ...
                <input type="text" name="name" placeholder="Contoh: Asep Putra" required>
            </div>

            <div class="form-full">
                <label class="form-label">Profesi</label>
                <input type="text" name="profesi" placeholder="Contoh: Pengusaha Muda" required>
            </div>

            <div class="form-full">
                <label class="form-label">Pesan Testimoni</label>
                <textarea name="message" rows="5" placeholder="Tuliskan isi testimoni customer di sini..." required></textarea>
            </div>
            ...
            <div class="form-full">
                ...
                <div class="gambar-section">
                    <div class="gambar-box" id="preview-container">
                        <!-- Placeholder Ikon User (Sesuai Halaman Index) -->
